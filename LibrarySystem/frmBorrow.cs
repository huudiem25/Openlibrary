...
namespace LibrarySystem
{
    public partial class frmBorrow : Form
    {
        ...
        private void btn_Bsave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn phải điền tất cả.","Không hợp lệ.",MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            if(cboPurpose.Text == "Select")
            {
                MessageBox.Show("Vui lòng chọn mục đích.", "Không hợp lệ.", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            DateTime formatdate;
